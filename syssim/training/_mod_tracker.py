# Vendored from torch.distributed._tools.mod_tracker (torch 2.X). Divergences:
#   - none (file copied verbatim aside from this header)
...
class ModTracker:
    ...
    def _fw_pre_hook(self, mod, input):
        if getattr(torch._dynamo.eval_frame, "_is_in_optimized_module", lambda: False)():
            return
