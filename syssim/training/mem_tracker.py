# Vendored from torch.distributed._tools.mem_tracker (torch 2.X). Divergences:
#   - get_untyped_storages inlined from common_utils.py
#   - ModTracker imported from ._mod_tracker (our vendored copy)
#   - dropped: import torch.distributed._tools.fake_collectives
#   - __all__ extended to re-export _MemRefType, _ModState, _ModMemStats
...
from ._mod_tracker import ModTracker
...
__all__ = ["MemTracker", "_MemRefType", "_ModState", "_ModMemStats"]
    ...
    def __torch_dispatch__(self, func, types, args=(), kwargs=None):  # type: ignore[no-untyped-def]
        ...
        if (
            ...
            try:
                ...
                # aten._local_scalar_dense (tensor.item()) cannot be simulated in
                # FakeTensorMode; return 0 as a safe placeholder (same as tracer.py).
                return 0
